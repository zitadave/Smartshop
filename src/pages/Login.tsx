        ...
        <form onSubmit={handlePhoneSignIn} className="space-y-3.5">
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-16 pr-4 py-3.5 rounded-2xl border border-border dark:border-slate-700 bg-background text-foreground text-sm font-mono font-bold focus:outline-none focus:ring-2 focus:ring-primary/40 transition-all text-left"
              required
            />
          </div>
